        ...
        <header className="sticky top-0 z-40 bg-white shadow-sm">
            <div className="max-w-[1200px] mx-auto flex items-center justify-between px-4 md:px-6 py-2">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="text-samNavy font-heading text-lg font-bold">Samgnya Technologies Foundation</div>
                        <div className="text-xs text-gray-500">A National Hub for Quantum Secure Communications</div>
                    </div>
                </div>
